...
const LABELS: Record<string, StageQtyLabels> = {
  ...
  acid_wash: { in: "Sent", out: "Received", rejected: "Rejected", rework: false, balance: "With Vendor" },
  heat_setting: { in: "Sent", out: "Received", rejected: "Rejected", rework: false, balance: "With Vendor" },
  washing: { in: "Sent", out: "Received", rejected: "Rejected", rework: false, balance: "With Vendor" },
  cpl_wash: { in: "Sent", out: "Received", rejected: "Rejected", rework: false, balance: "With Vendor" },
  lubricant_wash: { in: "Sent", out: "Received", rejected: "Rejected", rework: false, balance: "With Vendor" },
  ...
  bit_cutting: { in: "Sent", out: "Received", rejected: "Rejected", rework: false, balance: "With Vendor" },
