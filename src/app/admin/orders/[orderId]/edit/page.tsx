...
export default async function EditOrderAdminPage({ params }: PageProps<"/admin/orders/[orderId]/edit">) {
  ...
  return (
    <div className="space-y-4">
      ...
      <OrderEditPanel orderId={orderId} redirectTo={`/admin/orders/${orderId}`} />
    </div>
  );
}
